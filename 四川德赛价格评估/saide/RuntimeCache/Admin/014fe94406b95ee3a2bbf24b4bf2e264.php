	...
	<form class="form form-horizontal" id="form-article-add">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo ($row1['title']); ?>" placeholder="" id="title" name="title">
			</div>
		</div>
             <div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<div class="uploader-thum-container">
                                    <div id="fileList" class="uploader-list">
                                         <input type="hidden" name="image" id="image" value="<?php echo ($row1['image']); ?>">
                                        <img width="180" src="/saide.<?php echo ($row1['image']); ?>">
                                    </div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo ($row1['document_number']); ?>" placeholder="" id="document_number" name="document_number">
			</div>
		</div>
                <div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">防伪编码：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo ($row1['code']); ?>" placeholder="" id="code" name="code">
			</div>
		</div>
                    <div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">委托单位：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo ($row1['company']); ?>" placeholder="" id="company" name="company">
			</div>
		</div>
                <div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">评估公司名称：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo ($row1['company_title']); ?>" placeholder="" id="company_title" name="company_title">
			</div>
		</div>
                <div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">报告日期：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo ($row1['report_date']); ?>" placeholder="" id="report_date" name="report_date">
			</div>
		</div>
                <div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">被评审单位地址：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo ($row1['locations']); ?>" placeholder="" id="locations" name="locations">
			</div>
		</div>
             <div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">签名评估师：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo ($row1['appraiser']); ?>" placeholder="" id="appraiser" name="appraiser">
			</div>
		</div>
             <div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">联系电话：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo ($row1['telephone']); ?>" placeholder="" id="telephone" name="telephone">
			</div>
		</div>
             <div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">联系手机：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo ($row1['phone']); ?>" placeholder="" id="phone" name="phone">
			</div>
		</div>
             <div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">通讯地址：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo ($row1['address']); ?>" placeholder="" id="address" name="address">
			</div>
		</div>
             <div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">电子邮件：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo ($row1['emali']); ?>" placeholder="" id="emali" name="emali">
			</div>
		</div>
             <div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">公司网址：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo ($row1['company_url']); ?>" placeholder="" id="company_url" name="company_url">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">声明：</label>
			<div class="formControls col-xs-8 col-sm-9"> 
                            <textarea id="statement" name="statement" class="textarea" ><?php echo ($row1['statement']); ?></textarea> 
			</div>
		</div>
		<div class="row cl">
...
<script type="text/javascript">
    $(function(){
       $('#but').click(function(){
          ...
          var url="<?php echo U('Column/security_updates');?>";
          var data={
    ...
    $(function(){
        ...
        var uploader = WebUploader.create({  
            ...
            // 文件接收服务端。  
            server: "<?php echo U('Admin/Column/security_adver_upload');?>",  
