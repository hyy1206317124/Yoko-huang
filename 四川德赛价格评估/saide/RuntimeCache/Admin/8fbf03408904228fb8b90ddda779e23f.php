	...
	<form class="form form-horizontal" id="form-article-add">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo ($row['title']); ?>" placeholder="" id="title" name="title">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">排序值：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo ($row['page']); ?>" placeholder="" id="page" name="page">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo ($row['stert']); ?>" placeholder="" id="stert" name="stert">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">内容摘要：</label>
			<div class="formControls col-xs-8 col-sm-9">
                            <textarea name="abstract" id="abstract" class="textarea"  placeholder="说点什么...最少输入10个字符">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9"> 
                            <textarea id="body" name="body" style="width:100%;height:400px;"><?php echo ($row['body']); ?></textarea> 
			</div>
		</div>
		<div class="row cl">
...
<script type="text/javascript">
    $(function(){
       $('#but').click(function(){
          ...
          var url="<?php echo U('Column/column_updates');?>";
          var data={id:id,image:image,page:page,stert:stert,abstract:abstract,body:body,title:title};
          var dataType='json';
          $.post(
                url,
                data,
