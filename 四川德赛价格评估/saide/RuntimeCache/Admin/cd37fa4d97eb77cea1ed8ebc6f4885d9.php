			...
			<div class="tabCon">
				<div class="row cl">
					...
					<div class="formControls col-xs-8 col-sm-9">
                                            <input type="text" id="url_title" name="url_title" placeholder="控制在25个字、50个字节以内" value="" class="input-text">
					</div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2">
						...
						网站链接：</label>
					<div class="formControls col-xs-8 col-sm-9">
                                            <input type="text" id="url_http" name="url_http" placeholder="&copy; 2016 H-ui.net" value="" class="input-text">
					</div>
				</div>
			</div>
		</div>
...
$(function(){
   $("#but").click(function(){
      ...
      var data = {url_title:url_title,url_http:url_http};
      var url = "<?php echo U('System/system_url');?>";
      var type = 'post';
      var dataType = "json";
      $.ajax({
              url,
