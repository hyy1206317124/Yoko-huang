...
<div class="page-container">
	<form class="form form-horizontal" id="form-article-add">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" id="document_number" name="document_number">
			</div>
		</div>
                    <div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" id="company_title" name="company_title">
			</div>
		</div>
                <div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">报告日期：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" id="report_date" name="report_date">
			</div>
		</div>
                <div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">被评审单位地址：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" id="locations" name="locations">
			</div>
		</div>
             <div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">签名评估师：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" id="appraiser" name="appraiser">
			</div>
		</div>
             <div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" id="emali" name="emali">
			</div>
		</div>
             <div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">公司网址：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" id="company_url" name="company_url">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">声明：</label>
			<div class="formControls col-xs-8 col-sm-9"> 
                            <textarea id="statement" name="statement" class="textarea" ></textarea> 
			</div>
		</div>
		<div class="row cl">
...
<script type="text/javascript">
    $(function(){
       $('#but').click(function(){
          ...
          var url="<?php echo U('Column/security_adds');?>";
          var data={
              uid:uid,image:image,document_number:document_number,company:company,statement:statement,
