...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 内容管理 <span class="c-gray en">&gt;</span> 防伪验证 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
...
<!--	<div class="text-c">
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20">
            <span class="l">
                ...
                <a class="btn btn-primary radius" onclick="picture_add('添加内容','<?php echo U('Column/security_add');?>')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加内容</a>
            </span> 
		...
		<table class="table table-border table-bordered table-bg table-hover table-sort">
			<thead>
				...
				<tr class="text-c" id="ad_id<?php echo $ro['id'];?>">
					...
					<td><?php echo ($ro['class_title']); ?></td>
                                        <td class="text-l"><a class="maincolor" href="/saide/Index/yanzheng/id/<?php echo ($ro['id']); ?>.html"><?php echo ($ro['title']); ?></a></td>
                                        <td><?php echo ($ro['code']); ?></td>
					<td><?php echo (time_date($ro['security_time'])); ?></td>
					<td class="td-manage">
                                            <a style="text-decoration:none" class="ml-5" onClick="picture_edit('编辑','<?php echo U("Column/security_update?id= ".$ro["id"]."&"."uid=".$ro["uid"]);?>','<?php echo ($ro["uid"]); ?>')" href="javascript:;" title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a> 
...
function picture_del(obj,id){
	layer.confirm('确认要删除吗？',function(index){
		$.ajax({
			type: 'POST',
			url: '<?php echo U("Column/security_delete");?>',
                        data:{id:id},
			dataType: 'json',
...
function datadel(){
    ...
    layer.confirm('确认要删除吗？',function(index){
        ...
        $.ajax({
            url:"<?php echo U('Column/security_delete_all');?>",
            data:{id:id_str},
            type:'post',
            dataType:'json',
