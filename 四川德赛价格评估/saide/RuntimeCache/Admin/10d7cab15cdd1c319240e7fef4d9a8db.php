...
<div class="page-container">
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l">
                ...
                <a class="btn btn-primary radius" onclick="picture_add('添加网站','<?php echo U('System/system_url');?>')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加网站</a>
            </span>
			...
			<thead>
				...
				<tr class="text-c" id="ad_id<?php echo $ro['id'];?>">
					...
					<td><?php echo ($ro['id']); ?></td>
                                        <td >
                                            <?php echo ($ro['url_title']); ?>
                                        </td>
                                        <td><?php echo ($ro['url_http']); ?></td>
					<td><?php echo (time_date($ro['url_time'])); ?></td>
                                        <td>
                                            <a style="text-decoration:none" class="ml-5" onClick="picture_edit('网站编辑','<?php echo U("system/system_url_update?id=".$ro["id"]);?>','1','800','500')" href="javascript:;" title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a>
...
function picture_del(obj,id){
	layer.confirm('确认要删除吗？',function(index){
		$.ajax({
			type: 'POST',
			url: '<?php echo U("System/system_url_delete");?>',
                        data:{id:id},
			dataType: 'json',
...
function datadel(){
    ...
    layer.confirm('确认要删除吗？',function(index){
        ...
        $.ajax({
            url:"<?php echo U('System/system_url_delete_all');?>",
            data:{id:id_str},
            type:'post',
            dataType:'json',
