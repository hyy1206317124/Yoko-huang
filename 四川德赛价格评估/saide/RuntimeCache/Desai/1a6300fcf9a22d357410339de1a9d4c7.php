...
<?php if(is_array($csxx)): $i = 0; $__LIST__ = $csxx;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ce): $mod = ($i % 2 );++$i;?><title><?php echo ($ce['title']); ?>_<?php echo ($base['base_title']); ?></title><?php endforeach; endif; else: echo "" ;endif; ?>
...
<div>
	...
	<div class="con_sub_right">
		...
		<div class="con_sub_right_head">
                    <?php if(is_array($csxx)): $i = 0; $__LIST__ = $csxx;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ce): $mod = ($i % 2 );++$i;?><div class="con_sub_right_head_mark"></div>
			<div class="con_sub_right_head_name"><?php echo ($ce['title']); ?></div><?php endforeach; endif; else: echo "" ;endif; ?> 
                        <div class="con_sub_right_head_more">
                            <span style="font-weight:bold;">当前位置: </span>
                            <a href="<?php echo U('Index/index');?>">主页</a> >
                        <a href='<?php echo U("Desai/Index/read?id=".$bares["uid"]);?>'><?php echo ($bares['class_title']); ?></a> > 
                          </div>
                    </div>
                
		<div class="con_sub_right_con">
                    <?php if(is_array($csxx)): $i = 0; $__LIST__ = $csxx;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ro): $mod = ($i % 2 );++$i;?><h3><?php echo ($ro['title']); ?></h3>
