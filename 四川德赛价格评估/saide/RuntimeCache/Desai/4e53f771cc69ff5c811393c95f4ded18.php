...
<title><?php echo ($pages['class_title']); ?>_<?php echo ($base['base_title']); ?></title>
...
<div>
	...
	<div class="con_sub_right">
			...
			<div class="con_sub_right_head_name"><?php echo ($pages['class_title']); ?></div>
			...
			<span style="font-weight:bold;">当前位置：</span>
                        ...
                        <a><?php echo ($pages['class_title']); ?></a> > 
			</div>
