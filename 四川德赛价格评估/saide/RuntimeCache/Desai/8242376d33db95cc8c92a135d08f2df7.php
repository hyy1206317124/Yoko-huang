...
<?php if(is_array($infor)): $i = 0; $__LIST__ = $infor;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$bo): $mod = ($i % 2 );++$i;?><title><?php echo ($bo['cate_title']); ?>_<?php echo ($base['base_title']); ?></title><?php endforeach; endif; else: echo "" ;endif; ?>
...
<div>
	...
	<div class="con_sub_right">
		<div class="con_sub_right_head">
                     <?php if(is_array($infor)): $i = 0; $__LIST__ = $infor;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$bo): $mod = ($i % 2 );++$i;?><div class="con_sub_right_head_mark"></div>
			<div class="con_sub_right_head_name"><?php echo ($bo['cate_title']); ?></div>
			...
			<span style="font-weight:bold;">当前位置：</span>
                        ...
                        <a href='<?php echo U("Desai/Index/info?id=".$bo["id"]);?>'><?php echo ($bo['cate_title']); ?></a> ><?php endforeach; endif; else: echo "" ;endif; ?>
			</div>
		</div>
		<div class="con_sub_right_con">
			<ul>
                            <?php if(is_array($infot)): $i = 0; $__LIST__ = $infot;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$co): $mod = ($i % 2 );++$i;?><li class="con_sub_right_con_list">
					<a class="core" href="<?php echo U('Desai/Index/info_body?id='.$co['id'].'&'.'uid='.$co['uid']);?>" target="_blank"><?php echo ($co['information_title']); ?></a>
                                        <span><?php echo (time_date($co['information_time'] )); ?></span>
				</li><?php endforeach; endif; else: echo "" ;endif; ?>
			</ul>
                    <div class="pages"><?php echo ($ps); ?></div>
		</div>
	</div>
