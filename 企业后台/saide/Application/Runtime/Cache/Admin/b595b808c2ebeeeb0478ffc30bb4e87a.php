...
<aside class="Hui-aside">
	<div class="menu_dropdown bk_2">
		...
		<dl id="menu-product">
			...
			<dd>
				<ul>
					<li> <a data-href="<?php echo U('Column/yoko_class');?>" data-title="服务栏目" href="javascript:void(0)">栏目管理</a></li>
			</ul>
		</dd>
			...
			<dd>
				<ul>
					<li><a data-href="<?php echo U('Column/lists');?>" data-title="服务内容" href="javascript:void(0)">内容管理</a></li>
			</ul>
		</dd>
	</dl>
		<dl id="menu-comments">
		...
		<dl id="menu-system">
            ...
            <dl id="menu-picture">
                <dt><i class="Hui-iconfont">&#xe723;</i> <a data-href="<?php echo U('Image/lists');?>" data-title="网站首页" href="javascript:void(0)">网站首页</a></dt>
	</dl>
</div>
</aside>
