	...
	<form>
		<div class="row cl">
			...
			<div class="formControls col-xs-6 col-sm-6">
				...
				<input type="text" class="input-text" value="<?php echo ($row['class_title']); ?>" placeholder="" id="class_title" name="class_title">
			</div>
		</div>
...
$(function(){
	$('#sub').click(function(){
           ...
           var url="<?php echo U('Column/yokos_class_update');?>";
           var data={};
