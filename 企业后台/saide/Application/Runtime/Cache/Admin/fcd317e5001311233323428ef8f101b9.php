...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 栏目管理 <span class="c-gray en">&gt;</span>服务栏目 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
			...
			<thead>
				...
				<tr class="text-c" id="ad_id<?php echo $ro['id'];?>">
					...
					<td><?php echo ($ro['id']); ?></td>
                                        ...
                                        <td >
                                            <a href="<?php echo U('Column/cate_lists?id='.$ro['id']);?>"><?php echo ($ro['class_title']); ?></a>
                                        </td>
...
function picture_del(obj,id){
	layer.confirm('确认要删除吗？',function(index){
		$.ajax({
			type: 'POST',
			url: '<?php echo U("Column/yoko_colimn_delete");?>',
                        data:{id:id},
			dataType: 'json',
