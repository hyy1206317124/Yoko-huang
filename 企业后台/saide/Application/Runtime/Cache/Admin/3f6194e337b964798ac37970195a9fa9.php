...
<div class="page-container">
	<form class="form form-horizontal" id="form-article-add">
             <input type="hidden" name="information_image" id="information_image" >
             <input type="hidden" name="thumb_path" >
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>标题：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" id="information_title" name="information_title">
			</div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" id="information_page" name="information_page">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
                            <textarea name="information_abstract" id="information_abstract" cols="" rows="" class="textarea"  placeholder="说点什么...最少输入10个字符" datatype="*10-100" dragonfly="true" nullmsg="备注不能为空！" onKeyUp="$.Huitextarealength(this,200)"></textarea>
			</div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9"> 
                            <textarea id="information_body" name="information_body" style="width:100%;height:400px;"></textarea> 
			</div>
		</div>
		<div class="row cl">
...
<script type="text/javascript">
    $(function(){
       $('#but').click(function(){
          ...
          if(!/^[0-9A-Za-z\u4e00-\u9fa5]{10,200}$/.test(information_abstract)){
          ...
          var url="<?php echo U('Information/information_doAdd');?>";
          var data={uid:uid,information_image:information_image,information_page:information_page,information_abstract:information_abstract,information_body:information_body,information_title:information_title};
          var dataType='json';
          $.post(
                url,
                data,
