			...
			<thead>
				...
				<tr class="text-c" id="ad_id<?php echo $ro['id'];?>">
					...
					<td><?php echo ($ro['id']); ?></td>
                                        <td><a href="#"><?php echo ($ro['class_title']); ?></a></td>
					<td><?php echo (date("Y-m-d H:i:s",$ro['class_time'])); ?></td>
                                        <td>
                                            <a style="text-decoration:none" class="ml-5" onClick="picture_edit('增加子类','<?php echo U("Column/yoko_class_update?id=".$ro["id"]);?>','1','800','500')" href="javascript:;" title="增加子类"><i class="Hui-iconfont">&#xe6f3;</i></a>
